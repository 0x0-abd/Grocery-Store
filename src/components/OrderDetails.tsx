        ...
        <div className="fixed inset-0 flex items-center justify-center z-50">
            ...
            <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg z-50 w-11/12 max-w-lg">
                ...
                <div className="space-y-4 text-gray-300">
                    ...
                    <h3 className="text-md font-semibold text-gray-900 dark:text-white mt-4">Products:</h3>
        ...
        <>
            <div className="flex flex-wrap items-center gap-y-4 py-6">
                ...
                <dl className="w-1/2 sm:w-1/4 lg:w-auto lg:flex-1">
                    ...
                    <dd className="mt-1.5 text-base font-semibold text-gray-900 dark:text-white">Rs. {total}</dd>
                </dl>
                ...
                <div className="w-full grid sm:grid-cols-2 lg:flex lg:w-64 lg:items-center lg:justify-end gap-4">
                    {status !== "complete" && status !== "cancelled" ? (
                        <>
                            ...
                            >
                                Cancel</button>
                            {user.isAdmin && <button type="button" className="w-full rounded-lg border border-green-700 px-3 py-2 text-center text-sm font-medium text-green-700 hover:bg-green-700 hover:text-white focus:outline-none focus:ring-4 focus:ring-green-300 dark:border-green-500 dark:text-green-500 dark:hover:bg-green-600 dark:hover:text-white dark:focus:ring-green-900 lg:w-auto"
                    ...
                    <button type="button" onClick={toggleModal} className="w-full inline-flex justify-center rounded-lg  border border-gray-200 bg-white px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700 lg:w-auto">Details</button>
                </div>
            </div>
